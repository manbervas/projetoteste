...
public class WithdrawnProcessMethodTest {
	Operation op;
	...
	public void success() throws OperationException, SibsException, AccountException {
		...
		this.op.process();
		this.op.process();
		assertTrue(this.op.getState() instanceof Deposited);
		assertEquals(150, this.services.getAccountByIban(this.targetIBAN).getBalance());
	}
