...
public class RegisteredProcessMethodTest {
	...
	public void success() throws OperationException, SibsException, AccountException {
		Operation op = new Operation(this.sourceIBAN, this.targetIBAN,100);
		op.process();
		assertTrue(op.getState() instanceof Withdrawn);
		assertEquals(op.getValue(), this.services.getAccountByIban(this.sourceIBAN).getBalance());
	}
