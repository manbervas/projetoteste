...
public class CancelledProcessMethodTest {
	Operation op;
	...
	@Test
	public void CancelAfterRegisteredTest() throws OperationException, SibsException, AccountException {
		this.op = new Operation(this.sourceIBAN, this.targetIBAN, 100);
		this.op.cancel();
	...
	@Test
	public void CancelAfterWithdrawnTest() throws OperationException, SibsException, AccountException {
		this.op = new Operation(this.sourceIBAN, this.targetIBAN, 100);
		this.op.process();
		this.op.cancel();
		assertTrue(this.op.getState() instanceof Cancelled);
	...
	@Test
	public void CancelAfterDepositedTest() throws OperationException, SibsException, AccountException {
		this.op = new Operation(this.sourceIBAN, this.targetIBAN, 100);
		this.op.process();
		this.op.process();
		this.op.cancel();
	...
	@Test
	public void CancelAfterCompletedTest() throws OperationException, SibsException, AccountException {
		this.op = new Operation(this.sourceIBAN, this.targetIBAN, 100);
		this.op.process();
		this.op.process();
		this.op.process();
		this.op.cancel();
		assertTrue(this.op.getState() instanceof Completed);
	}
